...
public class EWalletServiceController  {
	...
	public EWallet addMoney(@PathVariable("walletId") int walletId,
	...
	public List<Statement> getStatementsByWalletId(@PathVariable("walletId") int walletId){
		return walletService.getStatementByWalletId(walletId);
	}
	
	@ApiOperation("Get wallet by user ID")
	@GetMapping("/wallets/byuser/{userId}")
	public EWallet getWalletByUserId(@PathVariable("userId") int userId) {
	...
	public EWallet payByWallet(@PathVariable("amount") double amount,
								...
								@PathVariable("reciverId") int reciverId) throws Exception {
	...
	public EWallet payByWalletUser(@PathVariable("amount") double amount,
								@PathVariable("senderId") int senderId) throws Exception {
