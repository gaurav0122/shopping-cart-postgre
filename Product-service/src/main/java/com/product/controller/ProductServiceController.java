...
public class ProductServiceController{
	...
	@GetMapping("/allproduct/category/{categoryName}")
	...
	public List<Product> getProductByMerchantId(@PathVariable int merchantId){
		return productService.getProductByMerchantId(merchantId);
	}
	
	@GetMapping("/productType/byCategory/{cid}")
	public List<String> getProductTypeByCategory(@PathVariable("cid") int categoryId){
	...
	@PostMapping("/addall/products/{cid}")
	public String addpostAll(@RequestBody List<Product> list,@PathVariable("cid") int merchatId) {
		String mess = productService.addAllProducts(list,merchatId);
		return mess;
	}
