...
public class PdfService {
	...
	public String generatePdf(int orderId) throws FileNotFoundException {
	...
	//	UserProfile merchaProfile = getuser(order.get());
		...
		String path="C:\\Users\\gganpatl\\New folder\\Shopping cart postgre\\pdf\\Invoice1.pdf";
		...
		String imagePath = "C:\\Users\\gganpatl\\New folder\\Shopping cart postgre\\pdf\\qrcode.jpg";
		...
		buyerTable.addCell(new Cell()
							.add(new Paragraph()
									...
									.add(new Text(String.valueOf(order.getOrderId()))))
							.setBorder(Border.NO_BORDER));	
	...
	public Resource getFileAsResource(String fileCode) throws IOException {
        Path dirPath = Paths.get("C:\\Users\\gganpatl\\New folder\\Shopping cart postgre\\pdf\\");
	    ...
	    private UserProfile getuser(int userId) {
